...
-   The **odds ratio for low parity birth is 1.24**, suggesting that the odds of low birth weight are 1.06 times higher for mothers with high blood pressure compared to mothers without high blood pressure, adjusting for smoking, birth order and maternal age. The 95% confidence interval for the odds ratio is (0.47, 1.22) includes 1, indicating that the effect of high blood pressure on low birth weight is not statistically significant in this model. This is also suggested by the p-value of 0.812 ( \> 0.05) which indicates that the effect of high blood pressure is not statistically significant at 5 % level of significance.
