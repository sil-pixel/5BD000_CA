...
The descriptive statistics of the dataset are presented below. The dataset contains information about the birth weight of children and various other variables such as smoking during pregnancy, birth order of the child, age of the mother, systolic blood pressure before pregnancy, birth weight of the child, preterm birth, and child's requirement of neonatal care. - The birth weight of the child is categorized as low if it is below 2500 grams. - The high systolic blood pressure is categorized as high if it is above 135 mmHg.
...
As we can see that the categorical variables are converted to factors, and the continuous variables are displayed with their mean and standard deviation. Here are some key observations from the descriptive statistics:

-   40 percent of the mothers in the dataset smoked during pregnancy with the average age of the mothers being around 26 years.
-   77.2 percent of mothers were having either their first or second born child.
-   The average birth weight of the children is around 2840.11 grams, i.e., 31.1 percent of the children are born with low birth weight.
-   The factorization has helped with the inference that 25.1 percent of the mothers had high blood pressure before pregnancy.
...
-   The variable wt_moth was also removed as it was not relevant for the analysis.
-   The data was cleaned to remove any missing values and ensure that the data is ready for analysis.

### Code:

```{r}
# Remove the id and wt_moth variables
birthweight_analysis <- birthweight_analysis[, -c(4, 6)]
...
**8. Age and Neocare:** Maternal age does not contribute significantly to major morbidity of preterm neonates at discharge from neonatal intensive care. [@eventov-friedman2015]

**9. Birth and Neocare:** Neonatal care and birth order are not directly related because the observed variations in neonatal outcomes with birth order, such as neonatal death rates, are largely influenced by confounding factors like maternal age, parity-related biological changes, and individual susceptibility to adverse outcomes, rather than birth order itself. These effects are intertwined and cannot solely be attributed to the order of the child. [@james1970]
...
Logistic regression model formula: low ~ smoke + age + high_bp
...
Logistic regression model formula: low ~ smoke + age
...
Logistic regression model formula: low ~ smoke + high_bp
...
Logistic regression model formula: low ~ smoke
